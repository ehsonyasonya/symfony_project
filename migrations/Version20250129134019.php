    ...
    public function up(Schema $schema): void
{
    ...
    $this->addSql('CREATE UNIQUE INDEX UNIQ_appointments_employee_time ON appointments (employee_id, appointment_date, appointment_time)');
    ...
    $this->addSql('DROP INDEX UNIQ_6A41727A8C03F15C');
}
